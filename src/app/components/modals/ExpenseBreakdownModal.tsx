      ...
      >
        ...
        <div className="flex items-center justify-between px-5 pb-3 pt-5 shrink-0">
          ...
          <div className="text-right">
            <h2 className="text-lg font-bold text-white">Finly צופה שיצא החודש</h2>
            {upcoming.length > 0 && (
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-6">
          {upcoming.length === 0 ? (
            <p className="py-12 text-center text-sm text-white/60">אין הוצאות צפויות לחודש זה</p>
          ) : (
            <div className="flex flex-col gap-2 pt-1">
              ...
              {upcoming.map((entry) => (
                <div
                  key={entry.id}
                  className="flex items-center justify-between rounded-2xl px-4 py-3 opacity-80 bg-violet-500/10"
                >
                  ...
                  <p className="text-[16px] font-bold shrink-0 mr-3 text-purple-300/70">
